(() => {
  ...
  if (supportsScrollTimeline || prefersReduced) return;
  ...
  const step = () => {
    ...
    el.skyB.setAttribute("stop-color", "#121b33");
    el.sunCore.setAttribute("stop-color", "#ffd36e");
    el.sunHalo.setAttribute("stop-color", "#ffb36a");
